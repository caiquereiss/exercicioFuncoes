...
function calcularValorNota(valorSaque){
    if(valorSaque >= 100){
      console.log('Valor do saque é ' +valorSaque)
      return 100
...
function elaborarResultado(contador100,contador50,contador10,contador5,contador1){
    ...
    if(contador100 > 0){
      result += `${contador100} nota(s) de R$ 100. `
    }
    if(contador50 > 0){
      result += `${contador50} nota(s) de R$ 50. `
    }
    if(contador10 > 0){
      result += `${contador10} nota(s) de R$ 10. `
    }
    if(contador5 > 0){
      result += `${contador5} nota(s) de R$ 5. `
    }
    if(contador1 > 0){
      result += `${contador1} nota(s) de R$ 1. `
    }
    return result
}
